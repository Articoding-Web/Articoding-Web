  ...
  createGridPage(isBackgroundGrid: boolean) {
    ...
    let gridTable = this.rexUI.add.gridTable({
      ...
      createCellContainerCallback: function (cell, cellContainer) {
        ...
        (<RoundRectangle>(<Label>cellContainer).getElement('background')).setStrokeStyle(2, COLOR_DARK).setDepth(0);
        return cellContainer;
      },
      items: isBackgroundGrid ? this.createBackgroundItems() : this.createObjectItems()
    }).layout();
