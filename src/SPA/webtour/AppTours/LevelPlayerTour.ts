...
export default function LevelPlayerTour(): TourGuideStep[] {
    return [
        {
            "title": "Welcome to BlockLeap!",
            "content": "This is the Level Player, where you'll learn to program and help Froggy traverse the dungeons 🐸⚔",
            "order": 1,
            "group": "LevelPlayer"
        },
        {
